...
import { Calculator, TrendingUp, AlertCircle, Settings, Plus, Trash2, Edit2, Save, ArrowLeft } from 'lucide-react'
										...
										<tbody className='divide-y'>
											{yearData.map((data, index) => (
												<tr key={data.year} className='hover:bg-muted/50 transition-colors'>
													...
													<td className='text-right py-2 px-2'>{data.grossSalary.toLocaleString('pl-PL')} zł</td>
						...
						<div className='space-y-6'>
							...
							<Card className='p-6'>
								<div className='flex items-center justify-between mb-4'>
									<h3 className='text-lg font-bold text-foreground flex items-center gap-2'>🏥 Zwolnienia lekarskie</h3>
									<Button
										size='sm'
								...
								{showAddSickLeave && (
									<div className='mb-4 p-3 border rounded-lg space-y-2'>
										...
										<div className='flex gap-2'>
											...
											<Button size='sm' variant='outline' onClick={() => setShowAddSickLeave(false)} className='flex-1'>
												Anuluj
											</Button>
										</div>
									</div>
